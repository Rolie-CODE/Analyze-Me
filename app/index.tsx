    ...
    <ScrollView style={{backgroundColor: "white"}}>
        <View style= {{backgroundColor: "white",flex:1}}>
            <View style = {{marginLeft: 10, display:'flex', flexDirection:"row", gap: 60, marginRight:10, marginTop: 20}}>
                ...
                <View style = {{display:'flex', flexDirection:"row", gap: 72, alignItems: 'center'}}>
            ...
            <View>
                <View style = {{display:'flex', flexDirection:'row', gap:30, marginLeft:10, marginTop: 10}}>
                    
                    <View style = {{display:'flex', flexDirection:'row', width: width*0.44, borderColor: "#14B8A6", borderWidth: 0.5, height: 50,gap:8, borderRadius: 5}}>
                ...
                <View style = {{display:'flex', flexDirection:'row', gap:30, marginLeft:10, marginTop: 10}}>
                    ...
                    <View style = {{display:'flex', flexDirection:'row', width: width*0.44, borderColor: "#14B8A6", borderWidth: 0.5, height: 50, gap:8, borderRadius: 5}}>
                        <MaterialCommunityIcons name="bookshelf" size={24} color="#14B8A6" />
                        <Text style={{width : 150}}>
                            4. Academic Pressure
                        </Text>
                    </View>
                ...
                <View style = {{display:'flex', flexDirection:'row', gap:30, marginLeft:10, marginTop: 10}}>
                    ...
                    <View style = {{display:'flex', flexDirection:'row', width: width*0.44, borderColor: "#14B8A6", borderWidth: 0.5, height: 50, gap:8, borderRadius: 5}}>
                        <MaterialCommunityIcons name="seat-individual-suite" size={24} color="#14B8A6" />
                        <Text style={{width: 150}}>
                            8. Suicidal Thoughts
                        </Text>
                    </View>
                ...
                <View style = {{display:'flex', flexDirection:'row', gap:30, marginLeft:10, marginTop: 10}}>
                    ...
                    <View style = {{display:'flex', flexDirection:'row', width: width*0.44, borderColor: "#14B8A6", borderWidth: 0.5, height: 50, gap:8, borderRadius: 5}}>
                        <MaterialCommunityIcons name="hours-12" size={24} color="#14B8A6" />
                        <Text style={{width: 150}}>
                ...
                <View style= {{display:"flex", flexDirection:"row", margin: 10, marginTop: 20, gap: 9, borderWidth:0.5, height: 35, alignItems: "center", width: 380, marginLeft: 14}}>
                    <Entypo name="bar-graph" size={24} color="#14B8A6" style={{marginLeft: 5}}/>
                    <Text>
                        Current CGPA
                    </Text>
                </View>

                <View style={{backgroundColor:"green", width: 380, marginLeft: 14,}}>
                    <TouchableOpacity style = {{borderWidth:0.5,borderColor: "#14B8A6", width: 380, height:40, alignItems: "center"}}>
                        <Text style={{textAlign: "center", color:"white", alignItems:"center", marginTop: 10}}>
                            Analyze My Result
                        </Text>
                    </TouchableOpacity>
                </View>
